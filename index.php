                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="width:357px; height:144px;">
                        <div class="row">
                            ...
                            <div class="row">
                                <a href="#" style="text-decoration: none; font-size: 14px;" class="text-primary mt-2">view listed properties</a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="width:357px; height:144px;">
            ...
            <div class="row my-3">
                ...
                <div class="row d-flex justify-content-center p-4" style="background-color: white;">
                    ...
                    <div class="card mx-2" style="width: 14rem; background-color: #F9F9F9; color: black;">
                        <img src="./assets/img/prop-img/img-1.jpg" class="card-img mt-2" alt="image"
                    ...
                    <!-- CARD -->
                    <div class="card mx-2" style="width: 14rem; background-color: #F9F9F9; color: black;">
                        <img src="./assets/img/prop-img/img-3.jpg" class="card-img mt-2" alt="image"
                            style="width: 100%; height: 100%; object-fit: cover;">
                        <div class="card-body px-0">
                            <h5 class="card-title mb-3">Property Name</h5>
                            <h6 class="card-subtitle mb-1">Location</h6>
                    ...
                    <!-- CARD -->
                    <div class="card mx-2" style="width: 14rem; background-color: #F9F9F9; color: black;">
                        <img src="./assets/img/prop-img/img-4.jpg" class="card-img mt-2" alt="image"
                            style="width: 100%; height: 100%; object-fit: cover;">
                        <div class="card-body px-0">
                            <h5 class="card-title mb-3">Property Name</h5>
                            <h6 class="card-subtitle mb-1">Location</h6>
                    ...
                    <!-- CARD -->
                    <div class="card mx-2" style="width: 14rem; background-color: #F9F9F9; color: black;">
                        <img src="./assets/img/prop-img/img-5.jpg" class="card-img mt-2" alt="image"
                            style="width: 100%; height: 100%; object-fit: cover;">
                        <div class="card-body px-0">
                            <h5 class="card-title mb-3">Property Name</h5>
                            <h6 class="card-subtitle mb-1">Location</h6>
