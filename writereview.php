			...
			<div class="row">
				...
				<div class="col-md-7 ms-5 ">
					...
					<div>
						...
						<textarea type="text" class="form-control resize-none" rows="5" placeholder="I'am very satisfied on the house its so..."
							aria-label="Last name" name="review_text"><?php echo htmlspecialchars($_POST['review_text'] ?? '', ENT_QUOTES); ?></textarea>	
					</div>
